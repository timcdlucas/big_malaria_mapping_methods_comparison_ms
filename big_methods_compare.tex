...
Indoor residual spraying (IRS) is one of the main malaria control interventions. Mapping the distribution of IRS coverage at fine-scale is important for understanding what effect IRS has on malaria burden across Africa and for targeting interventions for the future.



\parttitle{Methods} %if any
A two-stage approach to map IRS usage across sub-Saharan Africa was used. Firstly, using Demographic Health Survey data from 2000 - 2016, a spatiotemporal geostatistical model was developed to predict the fine-scale structure of IRS coverage, defined by the proportion of household sprayed, across sub-Saharan Africa. The DHS data contained 19139 geolocated cluster surveys across 25 different countries between 2010 and 2016. Environmental and anthropological covariates at 5 x 5 km resolution were used to inform the model. In the second stage, coarse adminstrative level IRS covarage data across Africa was used calibrate the results of the geostatistical model. The final predictions from the model were validated against DHS data using performance metrics of correlation and RMSE, and this was compared with the previous best IRS coverage data at administrative level.

\parttitle{Results} %if any
{\color{red}Need to think of a sentence to say about the maps.} We found that high density of \emph{Anopheles gambiae} mosquitos, high temperature suitability index of \emph{Plasmodium falciparum}, and low elevation correlates with high IRS coverage. The fine-scale predictions of IRS coverage from 1997 - 2017 show better performance (higher correlation and lower RMSE) than the previous best estimates at adminstrative unit level when compared against DHS data.

\parttitle{Conclusion} %if any
This article provides the first high resolution (5 x 5 km) maps of IRS coverage across Africa between 1997 and 2017. These high resolution maps are important for informing future targetted interventions. More reliable information on IRS coverage with broader spatial and temporal data is needed to improve our understanding of one of the main malaria control interventions and its effect up malaria prevalence.
\end{abstract}
